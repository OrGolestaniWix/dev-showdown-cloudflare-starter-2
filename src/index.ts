		...
		switch (challengeType) {
			...
			case 'JSON_MODE': {
				...
				const result = await generateObject({
					...
					system:
						'Extract structured product information from the human-readable product description. Populate every field in the schema using only facts stated in the description. Preserve the exact product name, numeric values, units, and URLs as written.',
